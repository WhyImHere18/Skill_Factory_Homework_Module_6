...
int main()
{
	...
	while (open)
	{
		...
		{
		case 1:
			cout << "below shown players we have at the moment: " << endl << endl;
			j = 1;
			for (int i = 0; i < playersNum; i++)
			{
				cout << "Player No " << j << ":" << endl;
				list[i]->ShowSpec();
				j++;
			}
			...
			cin >> pNum;
			cout << endl;
			cout << "Ok, you've got it: " << endl << endl;
			cout << "Player No " << pNum << ":" << endl;
			list[pNum - 1]->ShowSpec();
			cout << endl;
			cout << "Bye!" << endl;
			open = false;
			break;
		case 2:
			cout << "below shown smartfones we have at the moment: " << endl << endl;
			j = 1;
			for (int i = playersNum; i < playersNum + smartfonesNum; i++)
			{
				cout << "Smartfone No " << j << ":" << endl;
				list[i]->ShowSpec();
				j++;
			}
			cout << "which one do you want to get? " << endl;
			for (int i = 1; i <= smartfonesNum - 1; i++)
			{
				cout << i << " or ";
			}
			cout << smartfonesNum << "?" << endl;
			int sNum;
			cin >> sNum;
			cout << endl;
			cout << "Ok, you've got it: " << endl << endl;
			cout << "Smartfone No " << sNum << ":" << endl;
			list[playersNum + sNum - 1]->ShowSpec();
			cout << endl;
			cout << "Bye!" << endl;
			open = false;
			break;
	...
	for (int i = 0; i < playersNum + smartfonesNum + smartwatchesNum; i++)
	{
		delete list[i];
	}
